...
void list_insert(struct list* list, void *key, void* val);
void list_remove(struct list* list, void *key, int (*cmp)(void* a, void* b));
int list_position(struct list* list, void *key, int (*cmp)(void* a, void* b));
void list_reverse(struct list* list);

void *list_find_val_by_key(struct list* list, void *key,
        int (*cmp)(void* a, void* b, int (*convert)(void*)), int (*convert)(void*));
void list_remove_by_key(struct list* list, void* key, int (*cmp)(void* a, void* b, int (*convert)(void*)),
        int (*convert)(void*));

void list_remove_enqueue_all(void *ht, struct list* list, int (*enqueue)(void *ht, void *key, void* value, int (*convert)(void*)),
        int (*convert)(void*));
